...
function brandload(mapdata) {
	...
	for ( var i = 0; i < brandLength; i++) {
		...
		if (mapdata.typedc[i].type_id==5){
			for(var j=0;j<3;j++){
				var a5 = "<a rel='nofollow' target='_blank' class='rel_a' href='/brand/doShop.xf/"+mapdata.listsh[j].brandId+"'>"+mapdata.listsh[j].brandName+"</a>"
			...
			for(var j=0;j<3;j++){
				var a6 = "<a rel='nofollow' target='_blank' class='rel_a' href='/brand/doShop.xf/"+mapdata.listgd[j].brandId+"'>"+mapdata.listgd[j].brandName+"</a>"
			...
			for(var j=0;j<3;j++){
				var a7 = "<a rel='nofollow' target='_blank' class='rel_a' href='/brand/doShop.xf/"+mapdata.listzd[j].brandId+"'>"+mapdata.listzd[j].brandName+"</a>"
			...
			for(var j=0;j<3;j++){
				var a8 = "<a rel='nofollow' target='_blank' class='rel_a' href='/brand/doShop.xf/"+mapdata.listss[j].brandId+"'>"+mapdata.listss[j].brandName+"</a>"
