        ...
        success:function (data) {
            ...
            for (var i=0;i<each_list.length;i++){
                var html = "<li ><a target=\"_blank\" href=\"/watch/doWatch.xf/"+each_list[i].watch_id+"\" class=\"s_goods_img\">\n" +
                    ...
                    "            <a target='_blank' th:href=\"/brand/doShop.xf/"+each_list[i].brandId+"\" class=\"s_shop\">\n" +
                    "            <span> "+each_list[i].watchBrand.country.cName+""+each_list[i].watchBrand.brandName+"官方旗舰店</span></a>\n" +
                    "           </div>\n" +
                    "            </div></li>";
                doc1.append(html);          //添加
            }
