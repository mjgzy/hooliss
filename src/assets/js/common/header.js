...
function brandload(mapdata) {
	...
	for ( let i = 0; i < brandLength; i++) {
		...
		if (mapdata.typedc[i].type_id==5){
			for(let j=0;j<3;j++){
				let a5 = "<a rel='nofollow' target='_blank' class='rel_a' href='/brand/doShop.xf/"+mapdata.listsh[j].brandId+"'>"+mapdata.listsh[j].brandName+"</a>"
				$(".elps1").eq(i).prepend(a5);
			}
			for (let k=0;k<listLength;k++){
				let listshb =
					"<li class='fl'>"
						+"<a href='/brand/doShop.xf/"+mapdata.listsh[k].brandId+"' >"
							+"<p class='p_logo lazy-load'>"

								+"<img src=\""+mapdata.listsh[k].b_logo+"\" alt=''>"
							+"</p>"
							+"<p class='p_name'>"+mapdata.listsh[k].brandName+"</p>"
						+"</a>"
					+"</li>"
			...
			for(let j=0;j<3;j++){
				let a6 = "<a rel='nofollow' target='_blank' class='rel_a' href='/brand/doShop.xf/"+mapdata.listgd[j].brandId+"'>"+mapdata.listgd[j].brandName+"</a>"
				$(".elps1").eq(i).prepend(a6);
			}
			for (let k=0;k<listLengthgd;k++){
				let listgdb =
					"<li class='fl'>"
					+"<a href='/brand/doShop.xf/"+mapdata.listgd[k].brandId+"'>"
					+"<p class='p_logo lazy-load'>"
					+"<img src=\""+mapdata.listgd[k].b_logo+"\" alt=''>"
					+"</p>"
					+"<p class='p_name'>"+mapdata.listgd[k].brandName+"</p>"
					+"</a>"
					+"</li>"
			...
			for(let j=0;j<3;j++){
				let a7 = "<a rel='nofollow' target='_blank' class='rel_a' href='/brand/doShop.xf/"+mapdata.listzd[j].brandId+"'>"+mapdata.listzd[j].brandName+"</a>"
				$(".elps1").eq(i).prepend(a7);
			}
			for (let k=0;k<listLengthzd;k++){
				let listzdb =
					"<li  class='fl'>"
					+"<a href='/brand/doShop.xf/"+mapdata.listzd[k].brandId+"'>"
					+"<p class='p_logo lazy-load'>"
					+"<img src=\""+mapdata.listzd[k].b_logo+"\" alt=''>"
					+"</p>"
					+"<p class='p_name'>"+mapdata.listzd[k].brandName+"</p>"
					+"</a>"
					+"</li>"
			...
			for(let j=0;j<3;j++){
				let a8 = "<a rel='nofollow' target='_blank' class='rel_a' href='/brand/doShop.xf/"+mapdata.listss[j].brandId+"'>"+mapdata.listss[j].brandName+"</a>"
				$(".elps1").eq(i).prepend(a8);
			}
			for (let k=0;k<listLengthss;k++){
				let listssb =
					"<li  class='fl'>"
					+"<a href='/brand/doShop.xf/"+mapdata.listss[k].brandId+"'>"
					+"<p class='p_logo lazy-load'>"
					+"<img src=\""+mapdata.listss[k].b_logo+"\" alt=''>"
					+"</p>"
					+"<p class='p_name'>"+mapdata.listss[k].brandName+"</p>"
					+"</a>"
					+"</li>"
